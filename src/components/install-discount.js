...
{/* <StaticImage src="../../static/default-og-image.jpg" alt="VidSocks" className="popp" style={{position:'absolute', zIndex:'-1', borderRadius:'12px 12px 12px 12px', backgroundSize:'cover'}} /> */}
