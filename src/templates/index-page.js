...
function AddSvg(){
  const svgUrl = "https://vidsocks.com/assets/" + frontmatter.svgImage.relativePath + ""
  return (
...
{Image ? (
            <GatsbyImage
              ...
              style={{height:'auto', width:'100vw', maxHeight:'100%', position:'relative', top:'0', zIndex:'0', objectFit:'contain', overflow:'hidden', border:'0px solid red !important'}}
            />
            
          ) : (

       
            <StaticImage src="../../static/default-og-image.jpg" alt="Default Image" style={{height:'auto', maxHeight:'100%', position:'relative', zIndex:'0', bottom:'0',border:'0px solid !important', objectFit:'contain',}} />
...
<section id="homeintro1" style={{display:'none', top:'0', paddingTop:'2rem', height:'', position:'relative', top:'0'}}>
<article>
